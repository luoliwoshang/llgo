...
!3 = !{!"*_llgo_github.com/goplus/llgo/cl/_testrt/tpabi.T[string,int]", i32 2, i32 0, !"Demo", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"github.com/goplus/llgo/cl/_testrt/tpabi.(*T[string,int]).Demo", !"github.com/goplus/llgo/cl/_testrt/tpabi.(*T[string,int]).Demo", i32 1, !"Info", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"github.com/goplus/llgo/cl/_testrt/tpabi.(*T[string,int]).Info", !"github.com/goplus/llgo/cl/_testrt/tpabi.(*T[string,int]).Info"}
!4 = !{!"_llgo_github.com/goplus/llgo/cl/_testrt/tpabi.T[string,int]", i32 1, i32 0, !"Info", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"github.com/goplus/llgo/cl/_testrt/tpabi.(*T[string,int]).Info", !"github.com/goplus/llgo/cl/_testrt/tpabi.T[string,int].Info"}
!5 = !{!"github.com/goplus/llgo/cl/_testrt/tpabi.main", !"_llgo_github.com/goplus/llgo/cl/_testrt/tpabi.I", !"Demo", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac"}
!6 = !{!"_llgo_github.com/goplus/llgo/cl/_testrt/tpabi.I", !"Demo", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac"}
