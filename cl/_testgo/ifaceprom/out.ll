...
_llgo_0:
  ...
  call void asm "movq $0, %mm0", "r,~{mm0}"(ptr %10)
...
_llgo_8:                                          ; preds = %_llgo_19
  ...
  call void asm "movq $0, %mm0", "r,~{mm0}"(ptr %55)
...
_llgo_10:                                         ; preds = %_llgo_8
  ...
  call void asm "movq $0, %mm0", "r,~{mm0}"(ptr %70)
...
_llgo_17:                                         ; preds = %_llgo_4
  ...
  call void asm "movq $0, %mm0", "r,~{mm0}"(ptr %91)
  %93 = call i64 %92()
  %94 = icmp ne i64 %93, 1
...
_llgo_19:                                         ; preds = %_llgo_6
  ...
  call void asm "movq $0, %mm0", "r,~{mm0}"(ptr %100)
  %102 = call i64 %101()
...
_llgo_21:                                         ; preds = %_llgo_12
  ...
  call void asm "movq $0, %mm0", "r,~{mm0}"(ptr %109)
...
_llgo_23:                                         ; preds = %_llgo_14
  ...
  call void asm "movq $0, %mm0", "r,~{mm0}"(ptr %119)
