...
!2 = !{!"*_llgo_go/token.Pos", i32 0, !"IsValid", !"_llgo_func$YHeRw3AOvQtzv982-ZO3Yn8vh3Fx89RM3VvI8E4iKVk", !"go/token.(*Pos).IsValid", !"go/token.(*Pos).IsValid"}
!3 = !{!"_llgo_go/token.Pos", i32 0, !"IsValid", !"_llgo_func$YHeRw3AOvQtzv982-ZO3Yn8vh3Fx89RM3VvI8E4iKVk", !"go/token.(*Pos).IsValid", !"go/token.Pos.IsValid"}
!4 = !{!"*_llgo_go/ast.ObjKind", i32 0, !"String", !"_llgo_func$zNDVRsWTIpUPKouNUS805RGX--IV9qVK8B31IZbg5to", !"go/ast.(*ObjKind).String", !"go/ast.(*ObjKind).String"}
!5 = !{!"_llgo_go/ast.ObjKind", i32 0, !"String", !"_llgo_func$zNDVRsWTIpUPKouNUS805RGX--IV9qVK8B31IZbg5to", !"go/ast.(*ObjKind).String", !"go/ast.ObjKind.String"}
!6 = !{!"_llgo_go/ast.Object"}
!7 = !{!"*_llgo_go/ast.Object", i32 0, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*Object).Pos", !"go/ast.(*Object).Pos"}
!8 = !{!"_llgo_go/ast.Ident"}
!9 = !{!"*_llgo_go/ast.Ident", i32 0, !"End", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*Ident).End", !"go/ast.(*Ident).End", i32 1, !"IsExported", !"_llgo_func$YHeRw3AOvQtzv982-ZO3Yn8vh3Fx89RM3VvI8E4iKVk", !"go/ast.(*Ident).IsExported", !"go/ast.(*Ident).IsExported", i32 2, !"Pos", !"_llgo_func$CJFKsfrtVsmWyEEPXCTr-THQYm4CSPEiO6h57SNQxKU", !"go/ast.(*Ident).Pos", !"go/ast.(*Ident).Pos", i32 3, !"String", !"_llgo_func$zNDVRsWTIpUPKouNUS805RGX--IV9qVK8B31IZbg5to", !"go/ast.(*Ident).String", !"go/ast.(*Ident).String", i32 4, !"go/ast.exprNode", !"_llgo_func$2_iS07vIlF2_rZqWB5eU0IvP_9HviM4MYZNkXZDvbac", !"go/ast.(*Ident).exprNode", !"go/ast.(*Ident).exprNode"}
!10 = !{!"_llgo_go/ast.ArrayType"}
