...
!2 = !{!"github.com/goplus/llgo/cl/_testgo/reflect.callClosure", !"_llgo_string"}
!3 = !{!"github.com/goplus/llgo/cl/_testgo/reflect.callFunc", !"_llgo_closure$QIHBTaw1IFobr8yvWpq-2AJFm3xBNhdW_aNBicqUBGk"}
!4 = !{!"github.com/goplus/llgo/cl/_testgo/reflect.callFunc", !"_llgo_int"}
!5 = !{!"github.com/goplus/llgo/cl/_testgo/reflect.callFunc", !"_llgo_string"}
!6 = !{!"github.com/goplus/llgo/cl/_testgo/reflect.callIMethod", !"*_llgo_github.com/goplus/llgo/cl/_testgo/reflect.T"}
!7 = !{!"github.com/goplus/llgo/cl/_testgo/reflect.callIMethod", !"_llgo_int"}
!8 = !{!"github.com/goplus/llgo/cl/_testgo/reflect.callIMethod", !"_llgo_string"}
!9 = !{!"github.com/goplus/llgo/cl/_testgo/reflect.callMethod", !"*_llgo_github.com/goplus/llgo/cl/_testgo/reflect.T"}
!10 = !{!"github.com/goplus/llgo/cl/_testgo/reflect.callMethod", !"_llgo_int"}
!11 = !{!"github.com/goplus/llgo/cl/_testgo/reflect.callMethod", !"_llgo_string"}
!12 = !{!"github.com/goplus/llgo/cl/_testgo/reflect.callSlice", !"_llgo_closure$FjMjjQr3-2iTiWyZP1IIQFOz0hUCa0OS6pEm5uVV6Pk"}
!13 = !{!"github.com/goplus/llgo/cl/_testgo/reflect.callSlice", !"_llgo_int"}
!14 = !{!"github.com/goplus/llgo/cl/_testgo/reflect.callSlice", !"[]_llgo_any"}
!15 = !{!"github.com/goplus/llgo/cl/_testgo/reflect.demo", !"_llgo_string"}
!16 = !{!"github.com/goplus/llgo/cl/_testgo/reflect.mapDemo1", !"map[_llgo_int]_llgo_string"}
!17 = !{!"github.com/goplus/llgo/cl/_testgo/reflect.mapDemo1", !"_llgo_string"}
!18 = !{!"github.com/goplus/llgo/cl/_testgo/reflect.mapDemo1", !"_llgo_int"}
!19 = !{!"github.com/goplus/llgo/cl/_testgo/reflect.mapDemo2", !"_llgo_int"}
!20 = !{!"github.com/goplus/llgo/cl/_testgo/reflect.mapDemo2", !"_llgo_string"}
!21 = !{!"github.com/goplus/llgo/cl/_testgo/reflect.callClosure", !"_llgo_reflect.Type", !"String", !"_llgo_func$zNDVRsWTIpUPKouNUS805RGX--IV9qVK8B31IZbg5to"}
!22 = !{!"github.com/goplus/llgo/cl/_testgo/reflect.callFunc", !"_llgo_reflect.Type", !"String", !"_llgo_func$zNDVRsWTIpUPKouNUS805RGX--IV9qVK8B31IZbg5to"}
!23 = !{!"github.com/goplus/llgo/cl/_testgo/reflect.callIMethod", !"_llgo_reflect.Type", !"String", !"_llgo_func$zNDVRsWTIpUPKouNUS805RGX--IV9qVK8B31IZbg5to"}
!24 = !{!"github.com/goplus/llgo/cl/_testgo/reflect.callMethod", !"_llgo_reflect.Type", !"String", !"_llgo_func$zNDVRsWTIpUPKouNUS805RGX--IV9qVK8B31IZbg5to"}
!25 = !{!"github.com/goplus/llgo/cl/_testgo/reflect.mapDemo1", !"_llgo_reflect.Type", !"Key", !"_llgo_func$b6KOG2Oj7wt8ogb9H8QPbhEfXhxMMjdxRZgPLK_UOwI"}
!26 = !{!"github.com/goplus/llgo/cl/_testgo/reflect.mapDemo1", !"_llgo_reflect.Type", !"Elem", !"_llgo_func$b6KOG2Oj7wt8ogb9H8QPbhEfXhxMMjdxRZgPLK_UOwI"}
...
!29 = !{!"_llgo_reflect.Type", !"Align", !"_llgo_func$ETeB8WwW04JEq0ztcm-XPTJtuYvtpkjIsAc0-2NT9zA"}
!30 = !{!"_llgo_reflect.Type", !"AssignableTo", !"_llgo_func$Kxk9fspGkjXcoNWf2ucHG1vOQ5VHxVtYionfm-DnvWE"}
!31 = !{!"_llgo_reflect.Type", !"Bits", !"_llgo_func$ETeB8WwW04JEq0ztcm-XPTJtuYvtpkjIsAc0-2NT9zA"}
!32 = !{!"_llgo_reflect.Type", !"CanSeq", !"_llgo_func$YHeRw3AOvQtzv982-ZO3Yn8vh3Fx89RM3VvI8E4iKVk"}
!33 = !{!"_llgo_reflect.Type", !"CanSeq2", !"_llgo_func$YHeRw3AOvQtzv982-ZO3Yn8vh3Fx89RM3VvI8E4iKVk"}
!34 = !{!"_llgo_reflect.Type", !"ChanDir", !"_llgo_func$JO3khPIbANSMBmoN6P7ybYAeUBd3Gv6toVUqNeE7qbE"}
!35 = !{!"_llgo_reflect.Type", !"Comparable", !"_llgo_func$YHeRw3AOvQtzv982-ZO3Yn8vh3Fx89RM3VvI8E4iKVk"}
!36 = !{!"_llgo_reflect.Type", !"ConvertibleTo", !"_llgo_func$Kxk9fspGkjXcoNWf2ucHG1vOQ5VHxVtYionfm-DnvWE"}
!37 = !{!"_llgo_reflect.Type", !"Elem", !"_llgo_func$b6KOG2Oj7wt8ogb9H8QPbhEfXhxMMjdxRZgPLK_UOwI"}
!38 = !{!"_llgo_reflect.Type", !"Field", !"_llgo_func$Q3NYrysaKgu1MtMuLQwb-k5QcKGHihnt-tV_NlNJQFA"}
!39 = !{!"_llgo_reflect.Type", !"FieldAlign", !"_llgo_func$ETeB8WwW04JEq0ztcm-XPTJtuYvtpkjIsAc0-2NT9zA"}
!40 = !{!"_llgo_reflect.Type", !"FieldByIndex", !"_llgo_func$LPPtiM49dEPl48CC3WRhXm3YPnfUJEZE_k8Tx3rMuSk"}
!41 = !{!"_llgo_reflect.Type", !"FieldByName", !"_llgo_func$dEvABJ5r0MMUlf4smWpIDG5dO8AuGklGdNJ1xneL3UM"}
!42 = !{!"_llgo_reflect.Type", !"FieldByNameFunc", !"_llgo_func$EGeBNdD7KOy92HWVCj7jpfMdAvbvJV3DKYuCcibxHEA"}
!43 = !{!"_llgo_reflect.Type", !"Implements", !"_llgo_func$Kxk9fspGkjXcoNWf2ucHG1vOQ5VHxVtYionfm-DnvWE"}
!44 = !{!"_llgo_reflect.Type", !"In", !"_llgo_func$dPYu3A0LoGTV2Hd8PW4KPw2ITiUSo9q-4Bg9ZrPITnY"}
!45 = !{!"_llgo_reflect.Type", !"IsVariadic", !"_llgo_func$YHeRw3AOvQtzv982-ZO3Yn8vh3Fx89RM3VvI8E4iKVk"}
!46 = !{!"_llgo_reflect.Type", !"Key", !"_llgo_func$b6KOG2Oj7wt8ogb9H8QPbhEfXhxMMjdxRZgPLK_UOwI"}
!47 = !{!"_llgo_reflect.Type", !"Kind", !"_llgo_func$w8Mj2LK8G5p7MIiGWR6MYjyXy3L8SVVzYlT1bb6KNXk"}
!48 = !{!"_llgo_reflect.Type", !"Len", !"_llgo_func$ETeB8WwW04JEq0ztcm-XPTJtuYvtpkjIsAc0-2NT9zA"}
!49 = !{!"_llgo_reflect.Type", !"Method", !"_llgo_func$FmJJGomlX5kINJGxQdQDCAkD89ySoMslAYFrziWInVc"}
!50 = !{!"_llgo_reflect.Type", !"MethodByName", !"_llgo_func$aM2cVUtLQbPq1YHtnabQiM7XJ5Cg5RyV6BIDWrqey7E"}
!51 = !{!"_llgo_reflect.Type", !"Name", !"_llgo_func$zNDVRsWTIpUPKouNUS805RGX--IV9qVK8B31IZbg5to"}
!52 = !{!"_llgo_reflect.Type", !"NumField", !"_llgo_func$ETeB8WwW04JEq0ztcm-XPTJtuYvtpkjIsAc0-2NT9zA"}
!53 = !{!"_llgo_reflect.Type", !"NumIn", !"_llgo_func$ETeB8WwW04JEq0ztcm-XPTJtuYvtpkjIsAc0-2NT9zA"}
!54 = !{!"_llgo_reflect.Type", !"NumMethod", !"_llgo_func$ETeB8WwW04JEq0ztcm-XPTJtuYvtpkjIsAc0-2NT9zA"}
!55 = !{!"_llgo_reflect.Type", !"NumOut", !"_llgo_func$ETeB8WwW04JEq0ztcm-XPTJtuYvtpkjIsAc0-2NT9zA"}
!56 = !{!"_llgo_reflect.Type", !"Out", !"_llgo_func$dPYu3A0LoGTV2Hd8PW4KPw2ITiUSo9q-4Bg9ZrPITnY"}
!57 = !{!"_llgo_reflect.Type", !"OverflowComplex", !"_llgo_func$cGkbH-2LQOLoq64Rqj3WeO56U8al7FfVkf5K1FFbPpE"}
!58 = !{!"_llgo_reflect.Type", !"OverflowFloat", !"_llgo_func$uk7PgUVap9GZdvS8R_mZCDbAbqnAbcNryqybtDogUNI"}
!59 = !{!"_llgo_reflect.Type", !"OverflowInt", !"_llgo_func$odFOIClZoEVGbTP_BEfZxVM5ex3r8Fj1afUEeP_awp8"}
!60 = !{!"_llgo_reflect.Type", !"OverflowUint", !"_llgo_func$7I97sofX8UqJA96mVIy89KPUfSM_efkrR-mJQ9qaHfk"}
!61 = !{!"_llgo_reflect.Type", !"PkgPath", !"_llgo_func$zNDVRsWTIpUPKouNUS805RGX--IV9qVK8B31IZbg5to"}
!62 = !{!"_llgo_reflect.Type", !"Size", !"_llgo_func$1kITCsyu7hFLMxHLR7kDlvu4SOra_HtrtdFUQH9P13s"}
