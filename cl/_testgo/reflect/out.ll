...
_llgo_2:                                          ; preds = %_llgo_5
  ...
  call void asm "movq $0, %mm0", "r,~{mm0}"(ptr %36)
...
_llgo_2:                                          ; preds = %_llgo_5
  ...
  call void asm "movq $0, %mm0", "r,~{mm0}"(ptr %32)
...
_llgo_2:                                          ; preds = %_llgo_5
  ...
  call void asm "movq $0, %mm0", "r,~{mm0}"(ptr %40)
...
_llgo_2:                                          ; preds = %_llgo_5
  ...
  call void asm "movq $0, %mm0", "r,~{mm0}"(ptr %34)
...
_llgo_9:                                          ; preds = %_llgo_8, %_llgo_7
  ...
  call void asm "movq $0, %mm0", "r,~{mm0}"(ptr %43)
...
_llgo_9:                                          ; preds = %_llgo_8, %_llgo_7
  ...
  call void asm "movq $0, %mm0", "r,~{mm0}"(ptr %50)
  ...
  call void asm "movq $0, %mm0", "r,~{mm0}"(ptr %62)
