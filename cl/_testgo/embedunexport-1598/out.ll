...
@"_llgo_github.com/goplus/llgo/cl/_testdata/embedunexport.Base" = weak_odr constant { %"github.com/goplus/llgo/runtime/abi.StructType", %"github.com/goplus/llgo/runtime/abi.UncommonType", [0 x %"github.com/goplus/llgo/runtime/abi.Method"] } { %"github.com/goplus/llgo/runtime/abi.StructType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 16, i64 8, i32 159878037, i8 5, i8 8, i8 8, i8 25, { ptr, ptr } { ptr @"github.com/goplus/llgo/runtime/internal/runtime.structequal", ptr @"_llgo_github.com/goplus/llgo/cl/_testdata/embedunexport.Base" }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @3, i64 18 }, ptr @"*_llgo_github.com/goplus/llgo/cl/_testdata/embedunexport.Base" }, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @4, i64 49 }, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" { ptr @"github.com/goplus/llgo/cl/_testdata/embedunexport.struct$9Lrk1PmOX8nhNTkUnXhJ9SmPekQ9DVC-LUY2ssenyVA$fields", i64 1, i64 1 } }, %"github.com/goplus/llgo/runtime/abi.UncommonType" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @4, i64 49 }, i16 0, i16 0, i32 24 }, [0 x %"github.com/goplus/llgo/runtime/abi.Method"] zeroinitializer }, align 8
...
@"github.com/goplus/llgo/cl/_testdata/embedunexport.struct$9Lrk1PmOX8nhNTkUnXhJ9SmPekQ9DVC-LUY2ssenyVA$fields" = weak_odr constant [1 x %"github.com/goplus/llgo/runtime/abi.StructField"] [%"github.com/goplus/llgo/runtime/abi.StructField" { %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @5, i64 4 }, ptr @_llgo_string, i64 0, %"github.com/goplus/llgo/runtime/internal/runtime.String" zeroinitializer, i1 false }], align 8
...
@"github.com/goplus/llgo/cl/_testdata/embedunexport.iface$gGW7PSocDeRlTvk5kuSew8C-TZ8OXQrGkMlj2EUlZ9E" = weak_odr constant %"github.com/goplus/llgo/runtime/abi.InterfaceType" { %"github.com/goplus/llgo/runtime/abi.Type" { i64 16, i64 16, i32 -699968828, i8 0, i8 8, i8 8, i8 20, { ptr, ptr } { ptr @"__llgo_stub.github.com/goplus/llgo/runtime/internal/runtime.interequal", ptr null }, ptr null, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @13, i64 58 }, ptr @"*github.com/goplus/llgo/cl/_testdata/embedunexport.iface$gGW7PSocDeRlTvk5kuSew8C-TZ8OXQrGkMlj2EUlZ9E" }, %"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @12, i64 52 }, %"github.com/goplus/llgo/runtime/internal/runtime.Slice" { ptr @"github.com/goplus/llgo/cl/_testdata/embedunexport.iface$gGW7PSocDeRlTvk5kuSew8C-TZ8OXQrGkMlj2EUlZ9E$imethods", i64 2, i64 2 } }, align 8
...
_llgo_0:
  %1 = alloca %"github.com/goplus/llgo/cl/_testgo/embedunexport-1598.Wrapped", align 8
...
_llgo_0:
  %2 = alloca %"github.com/goplus/llgo/cl/_testgo/embedunexport-1598.Wrapped", align 8
...
_llgo_0:
  %0 = call ptr @"github.com/goplus/llgo/cl/_testdata/embedunexport.NewBase"(%"github.com/goplus/llgo/runtime/internal/runtime.String" { ptr @0, i64 4 })
  %1 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.AllocZ"(i64 8)
  %2 = getelementptr inbounds %"github.com/goplus/llgo/cl/_testgo/embedunexport-1598.Wrapped", ptr %1, i32 0, i32 0
  store ptr %0, ptr %2, align 8
  %3 = call ptr @"github.com/goplus/llgo/runtime/internal/runtime.NewItab"(ptr @"github.com/goplus/llgo/cl/_testdata/embedunexport.iface$gGW7PSocDeRlTvk5kuSew8C-TZ8OXQrGkMlj2EUlZ9E", ptr @"*_llgo_github.com/goplus/llgo/cl/_testgo/embedunexport-1598.Wrapped")
...
!llgo.useiface = !{!0}
!llgo.methodinfo = !{!1, !2, !3, !4}
!llgo.useifacemethod = !{!5}
!llgo.interfaceinfo = !{!6, !7}
...
!1 = !{!"_llgo_github.com/goplus/llgo/cl/_testdata/embedunexport.Base", i32 0}
!2 = !{!"*_llgo_github.com/goplus/llgo/cl/_testdata/embedunexport.Base", i32 2, i32 0, !"Name", !"_llgo_func$zNDVRsWTIpUPKouNUS805RGX--IV9qVK8B31IZbg5to", !"github.com/goplus/llgo/cl/_testdata/embedunexport.(*Base).Name", !"github.com/goplus/llgo/cl/_testdata/embedunexport.(*Base).Name", i32 1, !"github.com/goplus/llgo/cl/_testdata/embedunexport.setName", !"_llgo_func$dlTgtqQDYoqfVBQYEBE1Fa3ytcia1pdKaKVOnw8ZjkA", !"github.com/goplus/llgo/cl/_testdata/embedunexport.(*Base).setName", !"github.com/goplus/llgo/cl/_testdata/embedunexport.(*Base).setName"}
!3 = !{!"_llgo_github.com/goplus/llgo/cl/_testgo/embedunexport-1598.Wrapped", i32 2, i32 0, !"Name", !"_llgo_func$zNDVRsWTIpUPKouNUS805RGX--IV9qVK8B31IZbg5to", !"github.com/goplus/llgo/cl/_testgo/embedunexport-1598.(*Wrapped).Name", !"github.com/goplus/llgo/cl/_testgo/embedunexport-1598.Wrapped.Name", i32 1, !"github.com/goplus/llgo/cl/_testdata/embedunexport.setName", !"_llgo_func$dlTgtqQDYoqfVBQYEBE1Fa3ytcia1pdKaKVOnw8ZjkA", !"github.com/goplus/llgo/cl/_testgo/embedunexport-1598.(*Wrapped).setName", !"github.com/goplus/llgo/cl/_testgo/embedunexport-1598.Wrapped.setName"}
!4 = !{!"*_llgo_github.com/goplus/llgo/cl/_testgo/embedunexport-1598.Wrapped", i32 2, i32 0, !"Name", !"_llgo_func$zNDVRsWTIpUPKouNUS805RGX--IV9qVK8B31IZbg5to", !"github.com/goplus/llgo/cl/_testgo/embedunexport-1598.(*Wrapped).Name", !"github.com/goplus/llgo/cl/_testgo/embedunexport-1598.(*Wrapped).Name", i32 1, !"github.com/goplus/llgo/cl/_testdata/embedunexport.setName", !"_llgo_func$dlTgtqQDYoqfVBQYEBE1Fa3ytcia1pdKaKVOnw8ZjkA", !"github.com/goplus/llgo/cl/_testgo/embedunexport-1598.(*Wrapped).setName", !"github.com/goplus/llgo/cl/_testgo/embedunexport-1598.(*Wrapped).setName"}
!5 = !{!"github.com/goplus/llgo/cl/_testgo/embedunexport-1598.main", !"_llgo_github.com/goplus/llgo/cl/_testdata/embedunexport.Object", !"Name", !"_llgo_func$zNDVRsWTIpUPKouNUS805RGX--IV9qVK8B31IZbg5to"}
!6 = !{!"_llgo_github.com/goplus/llgo/cl/_testdata/embedunexport.Object", !"Name", !"_llgo_func$zNDVRsWTIpUPKouNUS805RGX--IV9qVK8B31IZbg5to"}
!7 = !{!"_llgo_github.com/goplus/llgo/cl/_testdata/embedunexport.Object", !"github.com/goplus/llgo/cl/_testdata/embedunexport.setName", !"_llgo_func$dlTgtqQDYoqfVBQYEBE1Fa3ytcia1pdKaKVOnw8ZjkA"}
