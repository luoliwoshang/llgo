...
_llgo_1:                                          ; preds = %_llgo_0
  ...
  call void asm "movq $0, %mm0", "r,~{mm0}"(ptr %26)
...
_llgo_0:
  ret %"github.com/goplus/llgo/cl/_testgo/closureall.Fn" { ptr @"github.com/goplus/llgo/cl/_testgo/closureall.makeNoFree$1", ptr null }
}
