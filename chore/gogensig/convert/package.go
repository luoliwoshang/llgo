...
func (p *Package) NewTypeDecl(typeDecl *ast.TypeDecl) error {
	// For anonymous type nodes, do nothing
	// This case is typically generated by declarations like: typedef struct {} xxx
	// The actual typedef declaration will have the correct name and embedded type
